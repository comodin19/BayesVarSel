...
### Development release
You can track, download the latest version or contribute to the development of `BayesVarSel` at [https://github.com/carlosvergara/BayesVarSel](https://github.com/carlosvergara/BayesVarSel). To install the most recent version of the package (`r sub("Version: ", "", readLines('DESCRIPTION')[grepl('Version', readLines('DESCRIPTION'))])`) you should:

1. Install devtools from CRAN with `install.packages("devtools")`.
2. Install the development version of `BayesVarSel` from [GitHub](https://github.com/carlosvergara/BayesVarSel):
