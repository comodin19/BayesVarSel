...
### Development release
You can track, download the latest version or contribute to the development of `BayesVarSel` at [https://github.com/carlosvergara/BayesVarSel](https://github.com/comodin19/BayesVarSel). To install the most recent version of the package (`r sub("Version: ", "", readLines('DESCRIPTION')[grepl('Version', readLines('DESCRIPTION'))])`) you should:
